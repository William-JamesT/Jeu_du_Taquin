...
void Choix_decoupimg3()
{
    ...
    ChargerImage("../img/OTimage.png" ,10,10,0,0,200,133);

    /* Boutons */
    RemplirRectangle(100,200,50,50); /*3x3*/
    RemplirRectangle(200,200,50,50); /*4x4*/
    RemplirRectangle(300,200,50,50); /*5x5*/
    RemplirRectangle(400,200,50,50); /*6x6*/
    RemplirRectangle(500,200,50,50); /*7x7*/
    RemplirRectangle(600,200,50,50); /*8x8*/
    ...
    /*on attend le clic sur le decoupage voulu*/
    while (!SourisCliquee());
    SourisPosition();
    _xclic = _X;
    _yclic = _Y;
    ...
    {
        decoupage(3, 3, "../img/OTimage2.png");
        return;
    }
    ...
    if (_xclic >= 200 && _xclic <= 250 &&
        _yclic >= 200 && _yclic <= 250)
    {
        decoupage(4, 4, "../img/OTimage2.png");
        return;
    }
    ...
    if (_xclic >= 300 && _xclic <= 350 &&
        _yclic >= 200 && _yclic <= 250)
    {
        decoupage(5, 5, "../img/OTimage2.png");
        return;
    }
    ...
    if (_xclic >= 400 && _xclic <= 450 &&
        _yclic >= 200 && _yclic <= 250)
    {
        decoupage(6, 6, "../img/OTimage2.png");
        return;
    }
    ...
    if (_xclic >= 500 && _xclic <= 550 &&
        _yclic >= 200 && _yclic <= 250)
    {
        decoupage(7, 7, "../img/OTimage2.png");
        return;
    }
    ...
    if (_xclic >= 600 && _xclic <= 650 &&
        _yclic >= 200 && _yclic <= 250)
    {
        decoupage(8, 8, "../img/OTimage2.png");
        return;
    }
}
