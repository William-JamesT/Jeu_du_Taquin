...
void Choix_decoupimg2()
{
    ...
    ChargerImage("../img/Etooimage.png" ,10,10,0,0,200,125);
    ...
    {
        decoupage(3, 3, "../img/Etooimage.png");
        return;
    }
    ...
    if (_xclic >= 200 && _xclic <= 250 &&
        _yclic >= 200 && _yclic <= 250)
    {
        decoupage(4, 4, "../img/Etooimage.png");
        return;
    }
    ...
    if (_xclic >= 300 && _xclic <= 350 &&
        _yclic >= 200 && _yclic <= 250)
    {
        decoupage(5, 5, "../img/Etooimage.png");
        return;
    }
    ...
    if (_xclic >= 400 && _xclic <= 450 &&
        _yclic >= 200 && _yclic <= 250)
    {
        decoupage(6, 6, "../img/Etooimage.png");
        return;
    }
    ...
    if (_xclic >= 500 && _xclic <= 550 &&
        _yclic >= 200 && _yclic <= 250)
    {
        decoupage(7, 7, "../img/Etooimage.png");
        return;
    }
    ...
    if (_xclic >= 600 && _xclic <= 650 &&
        _yclic >= 200 && _yclic <= 250)
    {
        decoupage(8, 8, "../img/Etooimage.png");
        return;
    }
}